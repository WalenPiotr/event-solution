...
export class API {
     ...
     * @method
     * @name API#postEvent
     * @param {} eventDto - The event API description
     */
    postEvent(parameters: {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (parameters['eventDto'] === undefined) {
                reject(new Error('Missing required  parameter: eventDto'));
                return;
            }
    ...
    getEventURL(parameters: {} & CommonRequestOptions): string {
        let queryParameters: QueryParameters = {};
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/event';
        if (parameters.$path) {
     ...
     * @name API#getEvent
     */
    getEvent(parameters: {} & CommonRequestOptions): Promise < ResponseWithBody < 200, void >> {
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/event';
        if (parameters.$path) {
            path = (typeof(parameters.$path) === 'function') ? parameters.$path(path) : parameters.$path;
     ...
     * 
     * @method
     * @name API#deleteEvent
     * @param {string} id - The event API description
     */
